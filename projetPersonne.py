...
def writeParameters():
    ...
    file.write("heightWindow "+str(heightWindow)+"\n")
    file.write("widthWindow "+str(widthWindow)+"\n")
    file.write("nbStepW "+str(nbStepW)+"\n")
    file.write("nbStepH "+str(nbStepH)+"\n")
    file.write("nbStepWTest "+str(nbStepWTest)+"\n")
    file.write("nbStepWTest "+str(nbStepHTest)+"\n")
    file.write("nbWindows "+str(nbWindows)+"\n")
    file.write("rescales "+str(rescales)+"\n")
    file.write("rescalesTrain "+str(rescalesTrain)+"\n")
    file.write("rescalesTest "+str(rescalesTest)+"\n")
    file.write("#Hog params\n")
    file.write("orientation "+str(orientation)+"\n")
    file.write("pixelPerCell "+str(pixelPerCell)+"\n")
    file.write("cellsPerBlock "+str(cellsPerBlock)+"\n")
    file.write("#clfParams\n")
    file.write("CTrain "+str(CTrain)+"\n")
    file.write("CTest "+str(CTest)+"\n")
    file.write("validCroiseeFolds "+str(validCroiseeFolds)+"\n")
    file.close()
